...
- Legacy PKI state may prepare missing private control directories before locking, but only inventory installation, protected backup, and rollover status/migration may proceed. Normal CA and service commands must reject legacy or mixed authority layouts before operational reads or mutations.
