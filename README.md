...
- Python 3.14 or newer for the unified `platform-pki` zipapp and the Python-backed `platform-pki-print-cert`; other operational PKI commands remain on their existing Bash executables during migration
