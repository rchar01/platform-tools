...
- [`../bin/platform-pki`](../bin/platform-pki): Unified Python PKI migration interface with shared runtime, filesystem, fork-safe ordered advisory-lock, and bounded Linux durable-publication primitives, including guarded exact replacement; operational handlers remain unavailable during migration.
