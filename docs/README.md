...
- [`../bin/platform-pki`](../bin/platform-pki): Unified Python PKI migration interface; operational handlers remain on the compatibility commands during the foundation stage.
